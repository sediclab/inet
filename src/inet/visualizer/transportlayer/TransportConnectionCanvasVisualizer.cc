...
TransportConnectionCanvasVisualizer::CanvasConnection::CanvasConnection(cFigure *sourceFigure, cFigure *destinationFigure, int sourceModuleId, int destinationModuleId, int count) :
...
const TransportConnectionVisualizerBase::Connection *TransportConnectionCanvasVisualizer::createConnection(cModule *source, cModule *destination, tcp::TCPConnection *tcpConnection) const
{
...
void TransportConnectionCanvasVisualizer::addConnection(const Connection *connection)
{
...
void TransportConnectionCanvasVisualizer::removeConnection(const Connection *connection)
{
